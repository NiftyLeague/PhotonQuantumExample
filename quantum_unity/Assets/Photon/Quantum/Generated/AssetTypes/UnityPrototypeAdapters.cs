...
namespace Quantum.Prototypes.Unity {
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.PrototypeAttribute(typeof(Quantum.LittleGuyComponent))]
  public class LittleGuyComponent_Prototype : Quantum.PrototypeAdapter<Quantum.Prototypes.LittleGuyComponent_Prototype> {
    public Quantum.PlayerRef PlayerRef;
    public Quantum.Prototypes.BotType_Prototype BotType;
    public BotData_Prototype BotData;
    public Quantum.QBoolean IsBot;

    public sealed override Quantum.Prototypes.LittleGuyComponent_Prototype Convert(EntityPrototypeConverter converter) {
      var result = new Quantum.Prototypes.LittleGuyComponent_Prototype();
      result.PlayerRef = this.PlayerRef;
      result.BotType = this.BotType;
      result.BotData = this.BotData.Convert(converter);
  ...
  public class BotData_Prototype : Quantum.PrototypeAdapter<Quantum.Prototypes.BotData_Prototype> {
    public Quantum.Prototypes.Input_Prototype BotInput;
    [Quantum.LocalReference]
    public global::EntityPrototype TargetCollectible;
    public Quantum.AssetRefAIConfig Config;
    public Quantum.QBoolean Loaded;
